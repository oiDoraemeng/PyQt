...
class BasicTreeWidget(QMainWindow):
    def __init__(self,parent= None):
        ...
        root.setText(0,'根节点')
        # 给根节点设置图标
        root.setIcon(0,QIcon('../images//1.jpg'))
        # 给第一列设置列宽
        ...
        # 设置子节点第一列的图标
        child1.setIcon(0,QIcon('../images/2.jpg'))
        # 给子节点第一列添加复选框
        child1.setCheckState(0,Qt.Checked)
        # 设置子节点第二列的图标
        child1.setIcon(1, QIcon('../images/2.jpg'))
        ...
        # 设置子节点第一列设置图标
        child2.setIcon(0,QIcon('../images/3.jpg'))
        ...
        # 给子节点的第一列设置图标
        child2_.setIcon(0,QIcon('../images/4.jpg'))
        # 给子节点的第二列设置图标
        child2_.setIcon(1, QIcon('../images/2.jpg'))
